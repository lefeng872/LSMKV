...
correctness: bin src/skiplist/skiplist.o src/bloomfilter/bloomfilter.o src/vlog/vlog.o src/sstable/sstable.o src/kvstore/kvstore.o src/tests/correctness.o
...
persistence: bin src/skiplist/skiplist.o src/bloomfilter/bloomfilter.o src/vlog/vlog.o src/sstable/sstable.o src/kvstore/kvstore.o src/tests/persistence.o
...
main: bin src/skiplist/skiplist.o src/bloomfilter/bloomfilter.o src/vlog/vlog.o src/sstable/sstable.o src/kvstore/kvstore.o src/tests/main.o
